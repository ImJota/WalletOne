...
class Options {
    ...
    reset(name) {
        if (name != null) {
            ...
            this._values[declaration.name] = (0, declaration_1.getDefaultValue)(declaration);
    ...
    setValue(name, value, configPath) {
        ...
        const converted = (0, declaration_1.convert)(value, declaration, configPath !== null && configPath !== void 0 ? configPath : process.cwd());
